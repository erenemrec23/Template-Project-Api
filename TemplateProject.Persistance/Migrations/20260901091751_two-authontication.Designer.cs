...
namespace QrAssignment.Persistance.Migrations
{
    ...
    [Migration("20260901091751_two-authontication")]
    partial class twoauthontication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QrAssignment.Domain.Entity.App.AppUserTwoFactor", b =>
                {
                    b.Property<Guid>("AppUserId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTimeOffset?>("EnabledDate")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.ToTable("AppUserTwoFactor", (string)null);
                });

            modelBuilder.Entity("QrAssignment.Domain.Entity.App.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QrAssignment.Domain.Entity.App.PagePermissionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PagePermissionLogs", (string)null);
                });
            ...
            modelBuilder.Entity("QrAssignment.Domain.Entity.App.AppUserTwoFactor", b =>
                {
                    b.HasOne("QrAssignment.Domain.Entity.App.AppUser", "AppUser")
                        .WithOne("TwoFactor")
                        .HasForeignKey("QrAssignment.Domain.Entity.App.AppUserTwoFactor", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
